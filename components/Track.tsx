...
const COLLISION_THRESHOLD_T = 0.0015;
            ...
            if (distT < COLLISION_THRESHOLD_T) {
                ...
                if (obs.type === 'ring') {
                    ...
                    if (angleDiff > safeZoneHalfWidth) hit = true;
                      ...
                      if (angleDiff < 0.08 || diff2 < 0.08) hit = true;
                    ...
                    if (diff1 < 0.08 || diff2 < 0.08 || diff3 < 0.08 || diff4 < 0.08) hit = true;
                } else {
                    if (angleDiff < 0.08) hit = true;
                }
