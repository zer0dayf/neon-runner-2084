  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-[10] select-none pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)]">
      ...
      {!showTitleScreen && !started && !gameOver && !levelComplete && (
        <div className="absolute inset-0 flex items-center justify-center z-[999] pointer-events-auto bg-black/80 backdrop-blur-lg overflow-y-auto">
          <div className="w-full max-w-4xl p-4 md:p-8 relative flex flex-col h-full justify-center">
      ...
      {/* LANDSCAPE WARNING (Mobil için) */}
      <div className="landscape:hidden fixed inset-0 z-[1000] bg-black flex flex-col items-center justify-center text-center p-4">
